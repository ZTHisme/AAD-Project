...
public class BitmapUtil {
    private static final double MAX_AVAILABLE_SIZE_IN_ALLOCATION_BYTE_COUNT = 2500000; // 2.5 MB
    ...
    private static Bitmap scaleBitmapSize(byte[] data, int scale) {
        ...
        if (b.getAllocationByteCount() > MAX_AVAILABLE_SIZE_IN_ALLOCATION_BYTE_COUNT) {
    ...
    private static int calculateScaleToCompressBitmap(BitmapFactory.Options options) {
        final int reqWidth = 1280;
        final int reqHeight = 720;
